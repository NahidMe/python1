...
# Log faylını oxumaq
log_file = r"D:\AZTU\2024_imtahan_payiz\Python\just checking\server_logs.txt"
...
with open(r"D:\AZTU\2024_imtahan_payiz\Python\just checking\failed_logins.json", "w") as json_file:
...
with open(r"D:\AZTU\2024_imtahan_payiz\Python\just checking\threat_ips.json", "w") as json_file:
...
with open(r"D:\AZTU\2024_imtahan_payiz\Python\just checking\combined_security_data.json", "w") as json_file:
    json.dump(combined_data, json_file, indent=4)

# Log analizi mətn faylı
with open(r"D:\AZTU\2024_imtahan_payiz\Python\just checking\log_analysis.txt", "w") as txt_file:
    for ip, count in suspicious_ips.items():
        txt_file.write(f"IP: {ip}, Failed Attempts: {count}\n")

# CSV faylı yaratmaq
with open(r"D:\AZTU\2024_imtahan_payiz\Python\just checking\log_analysis.csv", "w", newline="") as csv_file:
